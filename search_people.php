	...
	<body>
			...
			<div class="content">
				<div class='container__1'>
					<div class="content__text break cancel">
                            ...
                            $result_name_1 = $mysql->query("SELECT * FROM `users` WHERE `name_tag` = '$name_user'");
							$name_result__1 = $result_name_1->fetch_assoc();
							if ($name_result__1 !="" and $name_result__1 != 0 ){
                            ...
                            <h2 class="txt"><?php echo $name_result__1['name'];?></h2>
        					    <p style = "text-align: center;"><img style = " border-radius: 50%; height: 80px;" src="<?php echo $avatar_1;?>" alt = "" align = "top"></p>
        						...
        						<p class="txt">Твой рейтинг: <?php echo $name_result__1['rp'] . " " . 'RP'  ?></p>
        ...
        ");
        				...
        				?></p>
        							...
        							<?php }
        							$result_name_for_search = $mysql->query("SELECT `name`, `id_discord`, `img`, `name_tag`, `tag` FROM `users`");
